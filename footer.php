...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-restara');?>
        
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-cafe-restaurant-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Restara','skt-restara'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
